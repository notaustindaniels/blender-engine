...
|---|---|---|---|
| city_builder | 1 | GAP | unclassified |
| road_network | 1 | GAP | unclassified |
| medieval_town_layout | 1 | GAP | unclassified |
| lot_subdivision | 1 | GAP | unclassified |
| highway_interchange | 1 | GAP | unclassified |
| bridge_generator | 1 | GAP | unclassified |
| tunnel_generator | 1 | GAP | unclassified |
| rail_track_generator | 1 | GAP | unclassified |
| street_furniture_scatter | 1 | GAP | unclassified |
| power_line_generator | 1 | GAP | unclassified |
| sidewalk_detail | 1 | GAP | unclassified |
| plaza_park_generator | 1 | GAP | unclassified |
| slum_shanty_generator | 1 | GAP | unclassified |
| cyberpunk_stack_generator | 1 | GAP | unclassified |
