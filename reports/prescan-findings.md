...
- human-cleared (with cited rationale): **6**
- **false-positive rate: 54.5%** (flagged-then-cleared / flagged) — high FP means the scanner is over-aggressive and the allowlist should grow
- **still blocked (awaiting review): 5** ['aachman98__sorcar.zip', 'charlesss07__blender-python-nodes.zip', 'dingdio__witcher3-blender-tools.zip', 'emgi96__trailprint3d.zip', 'itscubetime__fastpbr.zip']
